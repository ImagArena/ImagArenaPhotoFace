          ...
          <div className="">
            ...
            <div id="welcome" className="banner1">
              <div className="col-lg-5">
                ...
                <a href="mailto:contact@imagarena.org?subject=ImagArena Booking Request" target="_blank"><button type="button" className="btn btn-primary btn-lg">Call To Action <i className="fa fa-chevron-right"></i></button></a>
              </div>
            </div>

            <div className="row align-items-center stripe1 stripe-orange">
          ...
          <div id="programs" className="container program-area">
            ...
            <div className="row">
              <div className="col-lg-4">
                <Link to='kids'><img src={require("../images/kids.png")} className="img-fluid modules" alt="Responsive image" /></Link>
              </div>
              <div className="col-lg-4">
                <Link to='families'><img src={require("../images/families.png")} className="img-fluid modules" alt="Responsive image" /></Link>
              </div>
              <div className="col-lg-4">
                <Link to='adults'><img src={require("../images/adults.png")} className="img-fluid modules" alt="Responsive image" /></Link>
              </div>
            </div>
          </div>
